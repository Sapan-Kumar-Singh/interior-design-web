  ...
  const keyBenefits = [
    {
      ...
      description:
        "Carefully selected premium materials built for durability and timeless aesthetics.",
    },
    {
      icon: <Users size={14} />,
      title: "Experienced Professionals",
      description:
        "A skilled team dedicated to delivering exceptional craftsmanship and service.",
    },
    {
      icon: <Lightbulb size={14} />,
      title: "Customized Design Solutions",
      description:
        "Tailored remodeling concepts designed around your lifestyle and preferences.",
    },
    {
      icon: <ReceiptText size={14} />,
      title: "Transparent Pricing",
      description:
        "Clear quotations and honest pricing with no hidden surprises.",
    },
    {
      icon: <SquareDashedKanban size={14} />,
      title: "On-Time Project Delivery",
      description:
        "Efficient project management that keeps your renovation on schedule.",
    },
  ];
