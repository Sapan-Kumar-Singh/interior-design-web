...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 hover:cursor-pointer items-center justify-center rounded-sm border border-transparent bg-clip-padding text-[14px] font-semibold whitespace-nowrap transition-all outline-none select-none  text-cream focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-gold-dark hover:bg-gold-80 text-cream",
      ...
      size: {
        default:
          "h-[36px] p-2 px-3.5 mx-1 sm:py-3 sm:pl-[10px] sm:pr-[10px] gap-1.5",
